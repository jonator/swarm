...
import { GitBranch, CheckCircle, GitPullRequest } from "lucide-react"

const steps = [
  {
    number: "01",
    title: "Connect GitHub and Linear",
    description: "Seamlessly integrate your repositories and issue tracking with a few clicks.",
    icon: GitBranch,
    color: "#00A3A3",
  },
  {
    number: "02",
    title: "Assign Issues",
    description: "Tag issues for AI resolution and let the swarm analyze and prioritize them.",
    icon: CheckCircle,
    color: "#00D4FF",
  },
  {
    number: "03",
    title: "Review the PR",
    description: "Receive precision-crafted pull requests ready for your review and approval.",
    icon: GitPullRequest,
    color: "#4B0082",
  },
]
    ...
    <section id="how-it-works" className="py-20 px-4 bg-[#0A0A0A]">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">Get started in minutes with our simple three-step process</p>
        </div>
            ...
            >
              ...
              {index < steps.length - 1 && (
                <div
                  ...
                  style={{ "--next-step-color": steps[index + 1].color } as React.CSSProperties}
                />
              )}
            </div>
          ))}
