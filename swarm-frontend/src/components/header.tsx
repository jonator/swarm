      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link href="#features" className="text-gray-300 hover:text-[#00D4FF] transition-colors">
              Features
            </Link>
            <Link href="#how-it-works" className="text-gray-300 hover:text-[#00D4FF] transition-colors">
              How It Works
            </Link>
            <Link href="#pricing" className="text-gray-300 hover:text-[#00D4FF] transition-colors">
              Pricing
            </Link>
          ...
          <div className="hidden md:block">
            <Button size="sm" className="bg-[#00A3A3] hover:bg-[#00D4FF] text-white transition-all duration-300">
              Sign In
            </Button>
          </div>
