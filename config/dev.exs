...
config :swarm, SwarmWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "NOxdveo6KlO16NFdU9dA4XG89SKhFb8ktyPSq6xc+omG2pu7JSVr1q9YdsKGw24x",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:swarm, ~w(--sourcemap=inline --watch)]},
...
config :swarm, SwarmWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/swarm_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
